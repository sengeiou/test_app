...
public class BackApiGoodsController extends BaseController {
    ...
    public ReturnData addTagComposition(HttpServletRequest request, @RequestParam String tag_ids,
                                        @RequestParam String composition_ids, @RequestParam(defaultValue = "false") boolean is_main) throws Exception {
    ...
    @ResponseBody
    public ReturnListData findCpsByTagId(HttpServletRequest request, @RequestParam Long tag_id, @RequestParam boolean is_main,
