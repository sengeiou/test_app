...
import cn.bevol.statics.dao.mapper.UserStatisticalOldMapper;
import cn.bevol.statics.entity.model.UserStatistical;
import cn.bevol.statics.entity.statistics.DailyActive;
...
public class UserStatisticalService implements StatisticsI {
	...
	@Autowired
	UserStatisticalOldMapper userStatisticalOldMapper;
	...
	public int  addUserStatistical(){
		...
		userStatistical.setCreateTime(DateUtils.nowInMillis()/1000);
		userStatistical.setUpdateTime(DateUtils.nowInMillis()/1000);
		int flag = userStatisticalOldMapper.insertOrUpdate(userStatistical);
	...
	public List<UserStatistical> findByPage(String beginTime, String endTime ){
		...
		return userStatisticalOldMapper.findByPage(paged);
	}
	/***
	 * 查询某一天活跃数据
	...
	public UserStatistical findByStatisticsDate(String statisticsDate){
		...
		return userStatisticalOldMapper.findByStatisticsDate(Integer.parseInt(statisticsDate));
	}
