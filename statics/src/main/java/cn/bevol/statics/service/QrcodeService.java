...
import cn.bevol.statics.dao.mapper.QrcodeOldMapper;
...
public class QrcodeService {
	...
	public Integer add(String androidUrl, String iosUrl, String name, String ticket, String parameter, String parameter2, String remark) {
	   ...
	   return	qrcodeOldMapper.insertOrUpdate(record);
	}
	...
	public Paged findByPage(String parameter, String remark, Integer startPage ){
		...
		paged.setResult(qrcodeOldMapper.findByPage(paged));
		paged.setTotal(this.qrcodeOldMapper.findByPageCount(paged));
		return paged;
	}

	public Qrcode findById(Integer qrcodeId) {
		return qrcodeOldMapper.selectByPrimaryKey(qrcodeId);
	}
