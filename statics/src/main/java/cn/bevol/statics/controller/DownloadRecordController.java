...
import cn.bevol.statics.service.DownloadRecordService;
...
public class DownloadRecordController {
	...
	@RequestMapping(value = {"/static/download/add"})
	 ...
	 public Object downloadAdd(HttpSession session, HttpServletRequest request,
	        ...
	        return new ReturnData(downloadRecordService.insertOrUpdate(qrcodeId,qrcodeName,dataSource,dataSource2));
	 }
	...
	public Object downloadByPage(HttpSession session, HttpServletRequest request,
		 ...
		 return new ReturnData(downloadRecordService.findByPage(beginTime, endTime,startPage));
	}
