...
import cn.bevol.statics.service.AdvertisementService;
...
public class AdvertisementController {
    ...
    public Object insert(HttpSession session, HttpServletRequest request,
        ...
        return new ReturnData(advertisementService.insert(name,orientation,bannerType,type,entityId,entityName,imgUrl,positionType,redirectType,redirectUrl,classifyId,hidden,publishTime,overdueTime,creater));
    }
    ...
    public Object update(HttpSession session, HttpServletRequest request,
        ...
        return new ReturnData(advertisementService.update(id,name,orientation,type,bannerType,entityId,entityName,imgUrl,positionType,redirectType,redirectUrl,classifyId,hidden,publishTime,overdueTime,updater));
    }
    ...
    public Object state(@RequestParam Integer id,
                        @RequestParam Integer hidden,
                        @RequestParam String updater){
        return new ReturnData(advertisementService.status(id, hidden, updater));
    }
    /***
    ...
    public Object findAdByEntityId(HttpSession session, HttpServletRequest request,
                                   ...
                                   @RequestParam(required = false) String type,
                                   @RequestParam(required = false)Integer classifyId){
        return   new ReturnData(advertisementService.findAdByType(name,type,classifyId,"1"));
    }
    /**
     * 根据类型查询广告 V2
     * @param session
    ...
    public Object findAdByEntityId2(HttpSession session, HttpServletRequest request,
        ...
        return   new ReturnData(advertisementService.findAdByType(name,type,classifyId,positionType));
    }
    ...
    public Object findAdvertisementById(HttpSession session, HttpServletRequest request,
        ...
        return   new ReturnData(advertisementService.findAdvertisementById(id));
    }
