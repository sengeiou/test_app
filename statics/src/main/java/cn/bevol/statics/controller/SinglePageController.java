...
public class SinglePageController {
    ...
    public Object staticSinglePage(HttpSession session, HttpServletRequest request,
        ...
        return new ReturnData(singlePageService.staticPage(name, htmlName, serviceName, platform, ext, path));
    }
    ...
    public Object staticMyPage() throws IOException {
        return new ReturnData(singlePageService.staticPage("pc_my", "my/index", "", "pc", "html"));
    }
    ...
    public Object staticIndustryPage(){
        return new ReturnData(singlePageService.staticLoopPage("pc_industry", "industry", "industry", "pc", "", ""));
    }
    ...
    public Object staticSubjectListPage(){
        return new ReturnData(singlePageService.staticLoopPage("pc_subject_list", "zt", "subjectList", "pc", "", ""));
    }
    ...
    public Object staticAppSharePage(HttpSession session, HttpServletRequest request,
                                     ...
                                     @RequestParam(defaultValue ="", required = false) String serviceName,
                                     @PathVariable String htmlName) throws IOException {
        return new ReturnData(singlePageService.staticPage(name, "app_share/" + htmlName, serviceName, "m"));
    }
    ...
    public Object staticFindSharePage(HttpSession session, HttpServletRequest request,
        ...
        return new ReturnData(singlePageService.staticFindPage("wx_find", "app_share/article/" + id, id, "m"));
    }
    ...
    public Object staticListsSharePage(HttpSession session, HttpServletRequest request,
                                       @PathVariable String id) throws IOException {
        return new ReturnData(singlePageService.staticListsPage("wx_lists", "app_share/lists/" + id, id, "m"));
    }
    ...
    public Object staticFindSharePage(HttpSession session, HttpServletRequest request,
        ...
        return new ReturnData(singlePageService.staticFindJson(id));
    }
