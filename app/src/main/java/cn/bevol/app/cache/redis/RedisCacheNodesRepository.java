...
import cn.bevol.app.config.RedisConfig;
 ...
 */
@Repository
public class RedisCacheNodesRepository implements CommandLineRunner {
    ...
    protected String password = "rediSb20180109";
    ...
    /*{
        ...
        *//*ConfClient confClint = new ConfClient("common");
        ...
        //hosts.add("r-bp1bdba63bfff3f4.redis.rds.aliyuncs.com");
