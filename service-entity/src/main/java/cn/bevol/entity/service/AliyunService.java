...
public class AliyunService {
	...
	@Autowired
	TaobaoClient taobaoClient;// = new DefaultTaobaoClient("http://gw.api.taobao.com/router/rest", "23325511", "ee7fcc150be92eac0a10395590f96ae9");
	 ...
	 * @return
	 */
	public  boolean sendVcode(String phone,String vcode,int type) {
		String rejson="";
		try {
	...
	public  boolean sendEmailVcode(String email,String vcode,int type) {
		...
		try {
			...
			try {
				...
				map.put("email", email);
				map.put("vcode", vcode);
				new cn.bevol.log.LogException(ex,map);
			}
		}
		return false;
	}
	...
	public ReturnListData openSearch(String appName, String quertyString, long p, int rows, String... fields) {
		...
		String openSearchIndexPre=this.getPro("openSearchIndexPre");
	 ...
	 * @throws IOException
	 */
	public  void updateOpearch(String indexName,String appName,List<Map<String,Object>> feilds) throws ClientProtocolException, IOException {
		String openSearchIndexPre=this.getPro("openSearchIndexPre");
