...
import cn.bevol.model.items.CompositionItem;
...
//        String composition_url = "http://api.bevol.cn/composition/info/"+mid;
    ...
    private List<Composition> compositionList(Integer page) {
        ...
        return compositionMapper.compositionByPage(paged);
    }
    /***
     * 初始化成分线程
     */
                ...
                Executors.newFixedThreadPool(1).submit(new Runnable() {
                    public void run() {
                        try {
                            ...
                            int tatolPage = compositionMapper.selectTotal() / 20 + 1;
    ...
    public List<Composition> findCompositionByIds(String[] ids) {
        return compositionMapper.findCompositionByIds(ids);
    }*/
